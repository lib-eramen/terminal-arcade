...
//! add a `const` variable with a distinctive-enough identifier (no
//! `SCREAMING_SNAKE_CASE` enforced!), and put your name in! You might want to
//! also put your Git identifier/ GitHub username in the doc comment.
